...
import com.mapvina.android.plugins.annotation.MapVinaMapAction;
...
public class ScaleBarTest extends BaseActivityTest {
    ...
    private void setupScaleBar() {
        ...
        MapVinaMapAction.invoke(mapvinaMap, (uiController, mapvinaMap) -> {
            scaleBarPlugin = new ScaleBarPlugin(idlingResource.getMapView(), mapvinaMap);
    ...
    public void testTextBorder() {
        ...
        setupScaleBar();
        MapVinaMapAction.invoke(mapvinaMap, (uiController, mapvinaMap) -> {
            assertEquals(activity.getResources().getDimension(R.dimen.mapvina_scale_bar_text_border_width),
    ...
    public void testMargin() {
        ...
        setupScaleBar();
        MapVinaMapAction.invoke(mapvinaMap, (uiController, mapvinaMap) -> {
            assertEquals(activity.getResources().getDimension(R.dimen.mapvina_scale_bar_margin_left),
                scaleBarWidget.getMarginLeft(), 0);
            assertEquals(activity.getResources().getDimension(R.dimen.mapvina_scale_bar_margin_top),
                scaleBarWidget.getMarginTop(), 0);
            assertEquals(activity.getResources().getDimension(R.dimen.mapvina_scale_bar_text_margin),
    ...
    public void testBarHeight() {
        ...
        setupScaleBar();
        MapVinaMapAction.invoke(mapvinaMap, (uiController, mapvinaMap) -> {
            assertEquals(activity.getResources().getDimension(R.dimen.mapvina_scale_bar_height),
    ...
    public void testBorderWidth() {
        ...
        setupScaleBar();
        MapVinaMapAction.invoke(mapvinaMap, (uiController, mapvinaMap) -> {
            assertEquals(activity.getResources().getDimension(R.dimen.mapvina_scale_bar_border_width),
