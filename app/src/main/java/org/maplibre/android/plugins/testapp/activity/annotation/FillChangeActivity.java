...
import static com.mapvina.android.plugins.testapp.activity.annotation.FillChangeActivity.Config.*;
...
public class FillChangeActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MapVinaMapOptions options = new MapVinaMapOptions()
    ...
    @Override
    public void onMapReady(@NonNull MapVinaMap map) {
