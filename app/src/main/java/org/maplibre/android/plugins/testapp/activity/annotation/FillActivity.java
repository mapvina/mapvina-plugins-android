...
import com.mapvina.android.plugins.annotation.Fill;
import com.mapvina.android.plugins.annotation.FillManager;
import com.mapvina.android.plugins.annotation.FillOptions;
...
public class FillActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapView.getMapAsync(mapvinaMap -> mapvinaMap.setStyle(TestStyles.BRIGHT.getUrl(), style -> {
            ...
            fillManager = new FillManager(mapView, mapvinaMap, style);
