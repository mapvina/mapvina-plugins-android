package com.mapvina.android.plugins.testapp.activity.markerview
...
import com.mapvina.android.plugins.markerview.MarkerView
import com.mapvina.android.plugins.markerview.MarkerViewManager
...
class MarkerViewActivity :
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mapView.getMapAsync { mapvinaMap ->
            mapvinaMap.setStyle(TestStyles.BRIGHT.url) { _ ->
                findViewById<View>(R.id.fabStyles).setOnClickListener { mapvinaMap.setStyle(Utils.nextStyle) }

                mapvinaMap.moveCamera(CameraUpdateFactory.zoomTo(2.0))

                markerViewManager =
                    MarkerViewManager(mapView, mapvinaMap)
                createCustomMarker()
                createRandomMarkers()

                mapvinaMap.addOnMapLongClickListener(this@MarkerViewActivity)
                mapvinaMap.addOnMapClickListener(this@MarkerViewActivity)
            }
        }
    }
