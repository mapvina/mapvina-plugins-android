package io.github.mapvina.android.plugins.testapp.activity.offline
...
import io.github.mapvina.android.plugins.offline.model.OfflineDownloadOptions
import io.github.mapvina.android.plugins.offline.offline.OfflineConstants.KEY_BUNDLE
import io.github.mapvina.android.plugins.offline.offline.OfflineDownloadChangeListener
import io.github.mapvina.android.plugins.offline.offline.OfflinePlugin
import io.github.mapvina.android.plugins.offline.utils.OfflineUtils
import io.github.mapvina.android.plugins.testapp.R
import io.github.mapvina.android.plugins.testapp.databinding.ActivityOfflineRegionDetailBinding
...
class OfflineRegionDetailActivity : AppCompatActivity(),
    ...
    private fun setupUI(definition: OfflineRegionDefinition) {
        ...
        mapView?.getMapAsync { mapvinaMap ->
            // correct style
            mapvinaMap.setOfflineRegionDefinition(definition) { _ ->
                // restrict camera movement
                mapvinaMap.setLatLngBoundsForCameraTarget(definition.bounds)
    ...
    companion object {
        ...
        val KEY_REGION_ID_BUNDLE = "io.github.mapvina.android.plugins.offline.bundle.id"
    }
}
