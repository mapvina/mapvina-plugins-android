package io.github.mapvina.android.plugins.localization;


import static io.github.mapvina.android.style.expressions.Expression.raw;
...
public final class LocalizationPlugin {
     ...
     * @param mapvinaMap the Mapbox map object which your current map view is using for control
     * @param style     the Style object that represents a fully loaded style
     */
    public LocalizationPlugin(@NonNull MapView mapView, @NonNull final MapVinaMap mapvinaMap, @NonNull Style style) {
    ...
    public void setCameraToLocaleCountry(MapLocale mapLocale, int padding) {
        ...
        mapvinaMap.moveCamera(CameraUpdateFactory.newLatLngBounds(bounds, padding));
    }
