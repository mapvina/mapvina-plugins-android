package io.github.mapvina.android.plugins.building;
...
import static io.github.mapvina.android.constants.MapVinaConstants.MAXIMUM_ZOOM;
import static io.github.mapvina.android.constants.MapVinaConstants.MINIMUM_ZOOM;
 ...
 * Android v5.1.0.
 * <p>
 * Initialise this plugin in the {@link io.github.mapvina.android.maps.OnMapReadyCallback#onMapReady(MapVinaMap)}
 * and provide a valid instance of {@link MapView} and {@link MapVinaMap}.
 * </p>
 * <ul>
...
public final class BuildingPlugin {
     ...
     * @param MapVinaMap the MapVinaMap to apply building plugin with
     * @since 0.1.0
     */
    public BuildingPlugin(@NonNull MapView mapView, @NonNull final MapVinaMap MapVinaMap, @NonNull Style style) {
        this(mapView, MapVinaMap, style, null);
    }
