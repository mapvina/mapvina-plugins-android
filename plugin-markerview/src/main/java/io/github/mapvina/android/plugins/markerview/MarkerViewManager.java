package io.github.mapvina.android.plugins.markerview;
...
public class MarkerViewManager implements MapView.OnCameraDidChangeListener, MapView.OnCameraIsChangingListener {
     ...
     * @param mapvinaMap the MapboxMap to synchronise views with
     */
    public MarkerViewManager(MapView mapView, MapVinaMap mapvinaMap) {
    ...
    public void addMarker(@NonNull MarkerView markerView) {
        ...
        markerView.setProjection(mapvinaMap.getProjection());
