...
public class SymbolManager extends AnnotationManager<SymbolLayer, Symbol, SymbolOptions, OnSymbolDragListener, OnSymbolClickListener, OnSymbolLongClickListener> {
     ...
     *
     * @param mapvinaMap the map object to add symbols to
     * @param style     a valid a fully loaded style object
     */
    @UiThread
    public SymbolManager(@NonNull MapView mapView, @NonNull MapVinaMap mapvinaMap, @NonNull Style style) {
        this(mapView, mapvinaMap, style, null, null, (GeoJsonOptions) null);
    }
     ...
     */
    @UiThread
    public SymbolManager(@NonNull MapView mapView, @NonNull MapVinaMap mapvinaMap, @NonNull Style style, @Nullable String belowLayerId, @Nullable String aboveLayerId) {
        this(mapView, mapvinaMap, style, belowLayerId, aboveLayerId, (GeoJsonOptions) null);
    }
     ...
     */
    @UiThread
    public SymbolManager(@NonNull MapView mapView, @NonNull MapVinaMap mapvinaMap, @NonNull Style style, @Nullable String belowLayerId, @Nullable String aboveLayerId, @Nullable GeoJsonOptions geoJsonOptions) {
        this(mapView, mapvinaMap, style, new SymbolElementProvider(), belowLayerId, aboveLayerId, geoJsonOptions, DraggableAnnotationController.getInstance(mapView, mapvinaMap));
    }
     ...
     */
    @UiThread
    public SymbolManager(@NonNull MapView mapView, @NonNull MapVinaMap mapvinaMap, @NonNull Style style, @Nullable String belowLayerId, @Nullable String aboveLayerId, @NonNull ClusterOptions clusterOptions) {
        this(mapView, mapvinaMap, style, new SymbolElementProvider(), belowLayerId, aboveLayerId, new GeoJsonOptions().withCluster(true).withClusterRadius(clusterOptions.getClusterRadius()).withClusterMaxZoom(clusterOptions.getClusterMaxZoom()), DraggableAnnotationController.getInstance(mapView, mapvinaMap));
        clusterOptions.apply(style, coreElementProvider.getSourceId());
    }

    @UiThread
    SymbolManager(@NonNull MapView mapView, @NonNull MapVinaMap mapvinaMap, @NonNull Style style, @NonNull CoreElementProvider<SymbolLayer> coreElementProvider, @Nullable String belowLayerId, @Nullable String aboveLayerId, @Nullable GeoJsonOptions geoJsonOptions, DraggableAnnotationController draggableAnnotationController) {
        super(mapView, mapvinaMap, style, coreElementProvider, draggableAnnotationController, belowLayerId, aboveLayerId, geoJsonOptions);
    }
