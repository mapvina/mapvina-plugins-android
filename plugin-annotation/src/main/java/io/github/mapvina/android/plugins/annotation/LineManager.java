...
public class LineManager extends AnnotationManager<LineLayer, Line, LineOptions, OnLineDragListener, OnLineClickListener, OnLineLongClickListener> {
     ...
     *
     * @param mapvinaMap the map object to add lines to
     * @param style     a valid a fully loaded style object
     */
    @UiThread
    public LineManager(@NonNull MapView mapView, @NonNull MapVinaMap mapvinaMap, @NonNull Style style) {
     ...
     */
    @UiThread
    public LineManager(@NonNull MapView mapView, @NonNull MapVinaMap mapvinaMap, @NonNull Style style, @Nullable String belowLayerId, @Nullable String aboveLayerId) {
     ...
     */
    @UiThread
    public LineManager(@NonNull MapView mapView, @NonNull MapVinaMap mapvinaMap, @NonNull Style style, @Nullable String belowLayerId, @Nullable String aboveLayerId, @Nullable GeoJsonOptions geoJsonOptions) {
        this(mapView, mapvinaMap, style, new LineElementProvider(), belowLayerId, aboveLayerId, geoJsonOptions, DraggableAnnotationController.getInstance(mapView, mapvinaMap));
    }

    @UiThread
    LineManager(@NonNull MapView mapView, @NonNull MapVinaMap mapvinaMap, @NonNull Style style, @NonNull CoreElementProvider<LineLayer> coreElementProvider, @Nullable String belowLayerId, @Nullable String aboveLayerId, @Nullable GeoJsonOptions geoJsonOptions, DraggableAnnotationController draggableAnnotationController) {
