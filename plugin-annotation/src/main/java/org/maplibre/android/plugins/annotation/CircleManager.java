...
public class CircleManager extends AnnotationManager<CircleLayer, Circle, CircleOptions, OnCircleDragListener, OnCircleClickListener, OnCircleLongClickListener> {
     ...
     *
     * @param mapvinaMap the map object to add circles to
     * @param style     a valid a fully loaded style object
     */
    @UiThread
    public CircleManager(@NonNull MapView mapView, @NonNull MapVinaMap mapvinaMap, @NonNull Style style) {
     ...
     */
    @UiThread
    public CircleManager(@NonNull MapView mapView, @NonNull MapVinaMap mapvinaMap, @NonNull Style style, @Nullable String belowLayerId, @Nullable String aboveLayerId) {
     ...
     */
    @UiThread
    public CircleManager(@NonNull MapView mapView, @NonNull MapVinaMap mapvinaMap, @NonNull Style style, @Nullable String belowLayerId, @Nullable String aboveLayerId, @Nullable GeoJsonOptions geoJsonOptions) {
        this(mapView, mapvinaMap, style, new CircleElementProvider(), belowLayerId, aboveLayerId, geoJsonOptions, DraggableAnnotationController.getInstance(mapView, mapvinaMap));
    }

    @UiThread
    CircleManager(@NonNull MapView mapView, @NonNull MapVinaMap mapvinaMap, @NonNull Style style, @NonNull CoreElementProvider<CircleLayer> coreElementProvider, @Nullable String belowLayerId, @Nullable String aboveLayerId, @Nullable GeoJsonOptions geoJsonOptions, DraggableAnnotationController draggableAnnotationController) {
