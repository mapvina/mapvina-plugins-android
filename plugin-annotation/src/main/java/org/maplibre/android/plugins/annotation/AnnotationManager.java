...
public abstract class AnnotationManager<
    ...
    protected final MapVinaMap mapvinaMap;
    ...
    @UiThread
    protected AnnotationManager(MapView mapView, final MapVinaMap mapvinaMap, Style style,
        ...
        mapvinaMap.addOnMapClickListener(mapClickResolver = new MapClickResolver());
        mapvinaMap.addOnMapLongClickListener(mapClickResolver);
        ...
        mapView.addOnDidFinishLoadingStyleListener(new MapView.OnDidFinishLoadingStyleListener() {
            ...
            public void onDidFinishLoadingStyle() {
                mapvinaMap.getStyle(new Style.OnStyleLoaded() {
                    @Override
    ...
    public void onDestroy() {
        mapvinaMap.removeOnMapClickListener(mapClickResolver);
        mapvinaMap.removeOnMapLongClickListener(mapClickResolver);
     ...
     */
    private class MapClickResolver implements MapVinaMap.OnMapClickListener, MapVinaMap.OnMapLongClickListener {
    ...
    private T queryMapForFeatures(@NonNull LatLng point) {
        return queryMapForFeatures(mapvinaMap.getProjection().toScreenLocation(point));
    }

    @Nullable
    T queryMapForFeatures(@NonNull PointF point) {
        List<Feature> features = mapvinaMap.queryRenderedFeatures(point, coreElementProvider.getLayerId());
        if (!features.isEmpty()) {
