...
import static io.github.mapvina.android.plugins.annotation.ConvertUtils.convertArray;
...
public class SymbolManagerTest {
    ...
    private MapVinaMap mapvinaMap = mock(MapVinaMap.class);
    ...
    public void testInitialization() {
        symbolManager = new SymbolManager(mapView, mapvinaMap, style, coreElementProvider, null, null, null, draggableAnnotationController);
    ...
    public void testInitializationOnStyleReload() {
        ...
        verify(mapvinaMap).getStyle(styleLoadedArgumentCaptor.capture());
    ...
    public void testLayerBelowInitialization() {
        symbolManager = new SymbolManager(mapView, mapvinaMap, style, coreElementProvider, "test_layer", null, null, draggableAnnotationController);
        verify(style).addSource(geoJsonSource);
    ...
    public void testGeoJsonOptionsInitialization() {
        symbolManager = new SymbolManager(mapView, mapvinaMap, style, coreElementProvider, null, null, geoJsonOptions, draggableAnnotationController);
