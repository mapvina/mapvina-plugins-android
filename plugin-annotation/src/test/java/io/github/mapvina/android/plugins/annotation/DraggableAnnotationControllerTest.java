...
public class DraggableAnnotationControllerTest {
    ...
    public void before() {
        ...
        draggableAnnotationController = new DraggableAnnotationController(mapView, mapvinaMap, androidGesturesManager,
    ...
    public void gestureOnMoveMoveNoGeometryTest() {
        ...
        when(mapvinaMap.getProjection()).thenReturn(projection);
